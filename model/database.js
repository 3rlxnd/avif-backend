...
async function findUserByApiKeyAndSecret(req, res) {
    ...
    for (const user of users) {
        for (const keyObj of user.keys) {
            ...
            const isApiKeyValid = apiKey && await bcrypt.compare(apiKey, keyObj.apiKey);
            const isApiSecretValid = apiSecret && await bcrypt.compare(apiSecret, keyObj.apiSecret);
...
module.exports = { User, findUserByApiKeyAndSecret, addUser, incUsage, verifyQuota };